...
#define DIV_10000	0xd1b71759		// shift = 13 + 32
    ...
    int mask = _mm_movemask_epi8(_mm_cmpgt_epi8(tmp, _mm_setzero_si128()));

    //u32 tz = __builtin_clz( mask ) - 16 ;
    //u32 tz = u64_lz_bits(mask) - 48;
    u32 tz = u32_lz_bits((u32)mask);
...
// static const u64 pow10_base_and_pow5_rlz[(base_end - base_start+1)*2 + ratio + 1 + 0]={
// //pow10_base table
...
// 0xc3b8358109e84f07, 0x0a862f80ec4700c9, // e10 =  11 * 27 = 297
//     };
//     static const u64 pow5_rlz[27]={
// 0x8000000000000000,// = (5** 0) << clz(5** 0) = (5** 0) << 63
// 0xa000000000000000,// = (5** 1) << clz(5** 1) = (5** 1) << 61
// 0xc800000000000000,// = (5** 2) << clz(5** 2) = (5** 2) << 59
// 0xfa00000000000000,// = (5** 3) << clz(5** 3) = (5** 3) << 57
// 0x9c40000000000000,// = (5** 4) << clz(5** 4) = (5** 4) << 54
// 0xc350000000000000,// = (5** 5) << clz(5** 5) = (5** 5) << 52
// 0xf424000000000000,// = (5** 6) << clz(5** 6) = (5** 6) << 50
// 0x9896800000000000,// = (5** 7) << clz(5** 7) = (5** 7) << 47
// 0xbebc200000000000,// = (5** 8) << clz(5** 8) = (5** 8) << 45
// 0xee6b280000000000,// = (5** 9) << clz(5** 9) = (5** 9) << 43
// 0x9502f90000000000,// = (5**10) << clz(5**10) = (5**10) << 40
// 0xba43b74000000000,// = (5**11) << clz(5**11) = (5**11) << 38
// 0xe8d4a51000000000,// = (5**12) << clz(5**12) = (5**12) << 36
// 0x9184e72a00000000,// = (5**13) << clz(5**13) = (5**13) << 33
// 0xb5e620f480000000,// = (5**14) << clz(5**14) = (5**14) << 31
// 0xe35fa931a0000000,// = (5**15) << clz(5**15) = (5**15) << 29
// 0x8e1bc9bf04000000,// = (5**16) << clz(5**16) = (5**16) << 26
// 0xb1a2bc2ec5000000,// = (5**17) << clz(5**17) = (5**17) << 24
// 0xde0b6b3a76400000,// = (5**18) << clz(5**18) = (5**18) << 22
// 0x8ac7230489e80000,// = (5**19) << clz(5**19) = (5**19) << 19
// 0xad78ebc5ac620000,// = (5**20) << clz(5**20) = (5**20) << 17
// 0xd8d726b7177a8000,// = (5**21) << clz(5**21) = (5**21) << 15
// 0x878678326eac9000,// = (5**22) << clz(5**22) = (5**22) << 12
// 0xa968163f0a57b400,// = (5**23) << clz(5**23) = (5**23) << 10
// 0xd3c21bcecceda100,// = (5**24) << clz(5**24) = (5**24) <<  8
// 0x84595161401484a0,// = (5**25) << clz(5**25) = (5**25) <<  5
