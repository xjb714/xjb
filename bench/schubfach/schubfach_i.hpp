...
static inline void schubfach_f64_to_dec(double v,unsigned long long* dec,int* e10){
...
static inline void schubfach_f32_to_dec(float v,unsigned int* dec,int* e10){
    ...
    schubfach_32::ToDecimal32_v2(sig, exp, dec,e10);
}

char* schubfach_f64_to_str(double v,char* buffer){
    char* buf_end = schubfach::Dtoa(buffer, v);
    *buf_end = '\0';
    return buf_end;
}
