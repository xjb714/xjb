...
struct double_table_t
{
    ...
    unsigned char e10_variable_data[e10_UP - (e10_DN) + 1 + 1][max_dec_sig_len + 3 + 4] = {};
    unsigned char h7[2048] = {};
    unsigned char shuffle_table[e10_UP - (e10_DN) + 1 + 1][2][16] = {};
    constexpr double_table_t()
    {
        ...
        for (int e10 = e10_DN; e10 <= e10_UP + 1; e10++)
        {
            ...
            u64 trail_didit_pos_0 = (dot_pos <= 14 + 0 && (u64)tmp_data_ofs >= (u64)(-e10_DN)) ? 15 + 0 : 14 + 0;
            u64 trail_didit_pos_1 = (dot_pos <= 14 + 1 && (u64)tmp_data_ofs >= (u64)(-e10_DN)) ? 15 + 1 : 14 + 1;
            u64 one_pos_0 = (dot_pos <= 15 + 0 && (u64)tmp_data_ofs >= (u64)(-e10_DN)) ? 16 + 0 : 15 + 0;
            u64 one_pos_1 = (dot_pos <= 15 + 1 && (u64)tmp_data_ofs >= (u64)(-e10_DN)) ? 16 + 1 : 15 + 1;
            ...
            e10_variable_data[tmp_data_ofs][max_dec_sig_len + 3] = trail_didit_pos_0;
            e10_variable_data[tmp_data_ofs][max_dec_sig_len + 4] = trail_didit_pos_1;
            e10_variable_data[tmp_data_ofs][max_dec_sig_len + 5] = one_pos_0;
            e10_variable_data[tmp_data_ofs][max_dec_sig_len + 6] = one_pos_1;
            ...
            for (int j = 0; j < 16; j++)
            {
                int E10 = (e10 == e10_UP + 1) ? 0 : e10;
                shuffle_table[tmp_data_ofs][0][j] = (E10 < 0) ? v0++ : ((E10 + 1 == j) ? 0x80 : v0++);
                shuffle_table[tmp_data_ofs][1][j] = (E10 < 0) ? v1++ : ((E10 + 1 == j) ? 0x80 : v1++);
            }
        }
...
#define use_fast_path_for_integer_xjb 0
        ...
        if (dot_one == (1ull << 62)) [[unlikely]] // branch instruction , round to even
            one = 2;
        //one = up_down ? 0 : one;
