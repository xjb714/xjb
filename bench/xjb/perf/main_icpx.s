...
.LBB0_4:
	...
	shlq	$4, %rcx
	movq	_ZL12pow10_double+4688(%rcx), %r12
	shrl	$16, %edx
	addl	%edx, %r14d
	leal	7(%r14), %edx
	shlxq	%rdx, %r10, %rdx
	...
	shrq	$25, %r14
	imulq	$-100000000, %r14, %r14         # imm = 0xFA0A1F00
	vpsrlq	$25, %zmm0, %zmm0
	vpmadd52luq	%zmm4, %zmm0, %zmm5
	vpxor	%xmm0, %xmm0, %xmm0
	addq	%rdx, %r14
	vpbroadcastq	%r14, %zmm1
	leaq	15(%r12), %r14
...
.LBB0_7:
	...
	testq	%r9, %r9
	leaq	(%r11,%r11,4), %rdx
	movzbl	_ZL18e10_variable_data2+17(%r11,%r11,4), %r10d
	movzbl	_ZL18e10_variable_data2(%r15,%rdx), %edx
	movzbl	_ZL18e10_variable_data2+18(%r11,%r11,4), %r15d
	movzbl	_ZL18e10_variable_data2+19(%r11,%r11,4), %r11d
	leaq	(%rax,%r10), %rcx
	vmovdqu	%xmm0, (%rax,%r10)
	movq	%rbx, (%r14,%rcx)
	vmovups	(%r15,%rcx), %xmm0
	...
	je	.LBB0_20
.LBB0_8:
	movq	_ZL17exp_result_double+2592(,%r8,8), %rax
	movq	%rax, (%rcx,%rdx)
	shrq	$56, %rax
	addq	%rcx, %rax
	addq	%rdx, %rax
