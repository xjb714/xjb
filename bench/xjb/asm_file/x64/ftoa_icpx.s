...
# %bb.3:
	...
	orq	%r14, %r11
.LBB0_5:
	imulq	$78913, %rsi, %rsi              # imm = 0x13441
	movzbl	_ZL12double_table+15608(%rdx), %r15d
	sarq	$18, %rsi
	movq	%rsi, %r9
	notq	%r9
	shlq	$4, %r9
	shlxq	%r15, %r11, %rdx
	notl	%r11d
	movq	_ZL12double_table+4688(%r9), %r12
	mulxq	%r12, %rbx, %r8
	mulxq	_ZL12double_table+4696(%r9), %rdx, %rdx
	movb	$10, %r9b
	addq	%rbx, %rdx
	movb	$10, %bl
	adcq	$0, %r8
	...
	shrxq	%r9, %r12, %r9
	shrdq	$9, %r8, %rdx
	movabsq	$-9223372036854775802, %r12     # imm = 0x8000000000000006
	addq	%r9, %r11
	xorl	%r9d, %r9d
	cmpq	%rdx, %r11
	movq	%rdx, %r15
...
.LBB0_9:
	...
	movabsq	$999999999999999, %rbx          # imm = 0x38D7EA4C67FFF
	vmovdqu64	.LCPI0_2(%rip), %zmm4   # zmm4 = [45035996,450359963,4503599628,45035996274,450359962738,4503599627371,45035996273705,450359962737050]
                                        # AlignMOV convert to UnAlignMOV 
	xorl	%r10d, %r10d
	vmovdqu	.LCPI0_1(%rip), %xmm3           # xmm3 = [4048780183313844224,8678551244950751296]
                                        # AlignMOV convert to UnAlignMOV 
	leaq	(%rdx,%rdx,4), %rdx
	cmpq	%rbx, %r8
	...
	shrq	$26, %rbx
	movl	%ebx, %r14d
	imull	$-100000000, %ebx, %ebx         # imm = 0xFA0A1F00
	...
	cmpq	$20, %rsi
	cmovbq	%rsi, %r9
	orl	$808464432, %r11d               # imm = 0x30303030
	shll	$5, %r9d
	movzbl	_ZL12double_table+14953(%r9), %ebx
	movzbl	_ZL12double_table+14954(%r9), %r15d
	movzbl	_ZL12double_table+14955(%r9), %r12d
	movzbl	_ZL12double_table+14936(%r9,%r14), %r9d
	leaq	(%rcx,%rbx), %rsi
	vmovdqu	%xmm1, (%rcx,%rbx)
	movl	%r11d, 15(%r10,%rsi)
	movabsq	$99999999999999, %r10           # imm = 0x5AF3107A3FFF
	vmovups	(%r15,%rsi), %xmm0
	vmovups	%xmm0, (%r12,%rsi)
	movb	$46, (%rcx,%r15)
	cmpq	%r10, %r8
	jbe	.LBB0_10
.LBB0_13:
	movq	_ZL12double_table+12464(,%rdx,8), %rax
	movq	%rax, (%rsi,%r9)
	shrq	$56, %rax
	addq	%rsi, %rax
	addq	%r9, %rax
...
.LBB0_4:
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movq	$-1074, %r10                    # imm = 0xFBCE
	movq	%r14, %r11
	jmp	.LBB0_5
.LBB0_6:
	imulq	$315653, %r10, %rsi             # imm = 0x4D105
	movl	$584, %r9d                      # imm = 0x248
	movb	$9, %bpl
	addq	$-131072, %rsi                  # imm = 0xFFFE0000
	sarq	$20, %rsi
	imull	$-217707, %esi, %r8d            # imm = 0xFFFCAD95
	addl	$-217707, %r8d                  # imm = 0xFFFCAD95
	shrl	$16, %r8d
	addl	%r8d, %r10d
	subq	%rsi, %r9
	subq	%rsi, %r9
	leal	53(%r10), %r15d
	movq	_ZL12double_table(,%r9,8), %r8
	movl	%r10d, %r9d
	negb	%r9b
	shrxq	%r9, %r8, %r14
	shlxq	%r15, %r8, %r11
...
.L.str:
	...
	.type	.L.str.1,@object                # 
.L.str.1:
	.asciz	"inf\000\000\000\000"
	.size	.L.str.1, 8

	.type	.L.str.2,@object                # 
.L.str.2:
	.asciz	"nan\000\000\000\000"
	.size	.L.str.2, 8

	.type	.L.str.3,@object                # 
.L.str.3:
	.asciz	"0.0\000\000\000\000"
	.size	.L.str.3, 8
