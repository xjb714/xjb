...
# %bb.0:
	...
	movl	$_ZL16constants_double, %r15d
	#APP
	#NO_APP
	movb	$45, (%rdi)
	movq	%rdx, %rsi
...
.LBB0_4:
	...
	shlq	$4, %rcx
	movq	_ZL12pow10_double+4688(%rcx), %rbp
	shrl	$16, %edx
	addl	%edx, %r12d
	leal	7(%r12), %edx
	shlxq	%rdx, %r11, %rdx
...
.LBB0_7:
	...
	shll	$2, %ebx
	leaq	(%rbx,%rbx,4), %rdx
	movzbl	_ZL12double_table+15209(%rbx,%rbx,4), %r11d
	movzbl	_ZL12double_table+15192(%r15,%rdx), %edx
	movzbl	_ZL12double_table+15210(%rbx,%rbx,4), %r15d
	movzbl	_ZL12double_table+15211(%rbx,%rbx,4), %ebx
	leaq	(%rax,%r11), %rcx
	vmovdqu	%xmm0, (%rax,%r11)
	movq	%r12, (%r10,%rcx)
	vmovdqu	(%r15,%rcx), %xmm0
	vmovdqu	%xmm0, (%rbx,%rcx)
	movb	$46, (%rax,%r15)
	testq	%r9, %r9
	je	.LBB0_21
.LBB0_8:
