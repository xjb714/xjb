...
# %bb.0:
	...
	leaq	_ZL16constants_double(%rip), %r15
	#APP
	#NO_APP
	movb	$45, (%rdi)
	movq	%rcx, %rsi
...
# %bb.10:
	...
	je	.LBB0_11
.LBB0_12:
	imulq	$315653, %rcx, %r8              # imm = 0x4D105
	xorl	%r13d, %r13d
...
.LBB0_14:
	sarq	$20, %r8
	leaq	_ZL12pow10_double(%rip), %rbp
	...
	movq	%r8, %r14
	notq	%r14
	imull	$217707, %r14d, %ecx            # imm = 0x3526B
	shlq	$4, %r14
	movq	4688(%r14,%rbp), %r10
	shrl	$16, %ecx
	addl	%ecx, %r12d
	leal	7(%r12), %ecx
	shlxq	%rcx, %r11, %rdx
	...
	vpbroadcastq	.LCPI0_3(%rip), %zmm1   # zmm1 = [10,10,10,10,10,10,10,10]
...
.LBB0_20:
	...
	leaq	(%rdx,%rdx,4), %rcx
	movl	%ecx, %esi
	leaq	_ZL12double_table(%rip), %rcx
	leaq	(%rcx,%rsi,4), %r11
	movzbl	15209(%rcx,%rsi,4), %ebx
	movzbl	15192(%r15,%r11), %r11d
	movzbl	15210(%rcx,%rsi,4), %r15d
	movzbl	15211(%rcx,%rsi,4), %esi
	leaq	(%rax,%rbx), %rdx
	vmovdqu	%xmm0, (%rax,%rbx)
	movq	%r12, (%r10,%rdx)
	vmovdqu	(%r15,%rdx), %xmm0
	vmovdqu	%xmm0, (%rsi,%rdx)
	movb	$46, (%rax,%r15)
	testq	%r9, %r9
	je	.LBB0_21
.LBB0_25:
	movq	12464(%rcx,%r8,8), %rax
	movq	%rax, (%rdx,%r11)
	shrq	$56, %rax
	addq	%rdx, %rax
	addq	%r11, %rax
...
.LBB0_7:
	...
	movabsq	$545460846719, %rsi             # imm = 0x7F0000007F
	movl	$4294957296, %edi               # imm = 0xFFFFD8F0
	shrxq	%rdx, %r11, %rdx
	cmpq	$99999999, %rdx                 # imm = 0x5F5E0FF
	ja	.LBB0_9
# %bb.8:
	imulq	$109951163, %rdx, %r8           # imm = 0x68DB8BB
	shrq	$40, %r8
	imulq	%rdi, %r8
	addq	%rdx, %r8
	imulq	$5243, %r8, %rdx                # imm = 0x147B
	shrq	$19, %rdx
	andq	%rsi, %rdx
	...
	jmp	.LBB0_26
.LBB0_9:
	movabsq	$3022314549036573, %r8          # imm = 0xABCC77118461D
	mulxq	%r8, %r8, %r8
	shrq	$14, %r8
	...
	imulq	%rdi, %r11
	addq	%r8, %rdx
	imulq	$5243, %rdx, %rdi               # imm = 0x147B
	addq	%r9, %r11
	shrq	$19, %rdi
	andq	%rsi, %rdi
	imulq	$65436, %rdi, %rdi              # imm = 0xFF9C
	addq	%rdx, %rdi
...
# %bb.3:
	...
	jmp	.LBB0_26
.LBB0_11:
	movq	$-1074, %r12                    # imm = 0xFBCE
	movq	%rbx, %r11
	jmp	.LBB0_12
.LBB0_13:
	addq	$-131237, %r8                   # imm = 0xFFFDFF5B
	jmp	.LBB0_14
.LBB0_16:
	xorl	%r13d, %r13d
	jmp	.LBB0_17
...
_ZN3xjb5xjb32EfPc:                      # @_ZN3xjb5xjb32EfPc
	.cfi_startproc
# %bb.0:
	pushq	%r15
	.cfi_def_cfa_offset 16
...
# %bb.7:
	...
	je	.LBB1_9
# %bb.8:
	leaq	_ZL11float_table(%rip), %r8
	sarq	$12, %rcx
	xorl	%ebx, %ebx
	xorl	%r9d, %r9d
	movzbl	1084(%rdi,%r8), %r11d
.LBB1_10:
	leaq	_ZL11float_table(%rip), %r8
	movb	$65, %r15b
	shlxq	%r11, %rdx, %rdx
	...
	vinserti128	$0, .LCPI1_0(%rip), %ymm0, %ymm1
	...
	vmovq	.LCPI1_4(%rip), %xmm1           # xmm1 = [7,15,23,31,39,47,55,63,0,0,0,0,0,0,0,0]
	vpermb	%zmm0, %zmm1, %zmm0
	vmovq	%xmm0, %r10
	shrxq	%r11, %r10, %rbx
	movabsq	$3472328296227680304, %r11      # imm = 0x3030303030303030
	lzcntq	%rbx, %r10
	orq	%rbx, %r11
	movl	$8, %ebx
	shrl	$3, %r10d
	...
	orq	%r15, %r12
	leaq	(%r14,%r14,4), %r12
	movabsq	$423878912376825, %r15          # imm = 0x18183FFFFFFF9
	cmoveq	%rbx, %r10
	shrq	$32, %r14
	addq	%rbx, %rcx
	addq	%r14, %r15
...
.LBB1_15:
	...
	shll	$2, %eax
	movl	%r9d, %r14d
	movzbl	961(%r8,%r14,4), %r12d
	leaq	(%r8,%r14,4), %r13
	movzbl	952(%r10,%r13), %r10d
	movzbl	962(%r8,%r14,4), %r13d
	movzbl	963(%r8,%r14,4), %r14d
	leaq	(%rsi,%r12), %r9
	movq	%r11, (%rsi,%r12)
	movq	%r15, (%rbx,%r9)
	movq	(%r13,%r9), %r11
...
.LBB1_1:
	...
	je	.LBB1_3
# %bb.2:
	leaq	_ZL11float_table(%rip), %rax
	movq	$-45, %rcx
	xorl	%ebx, %ebx
	xorl	%r9d, %r9d
	movq	%r10, %rdx
	movzbl	1084(%rdi,%rax), %r11d
	movq	$-149, %rax
	jmp	.LBB1_10
.LBB1_6:
	testq	%r10, %r10
...
.LBB1_9:
	...
	movl	$1, %ebx
	sarq	$12, %rcx
	imull	$129371, %ecx, %r11d            # imm = 0x1F95B
...
.Lfunc_end1:
	...
	.cfi_endproc
                                        # -- End function
	.type	_ZL16constants_double,@object   # @_ZL16constants_double
	.section	.rodata,"a",@progbits
	.p2align	3, 0x0
...
_ZL12double_table:
	...
	.type	_ZL12pow10_double,@object       # @_ZL12pow10_double
	.p2align	4, 0x0
_ZL12pow10_double:
	.quad	-3720041912917459700            # 0xcc5fc196fefd7d0c
	.quad	2185351144835019465             # 0x1e53ed49a96272c9
	...
	.type	_ZL11float_table,@object        # @_ZL11float_table
	.p2align	3, 0x0
_ZL11float_table:
	...
	.addrsig
	.addrsig_sym _ZL16constants_double
