	...
	.p2align	4, 0x0                          # -- Begin function _Z5xjb64dPc
.LCPI0_0:
...
# %bb.10:
	...
	je	.LBB0_11
.LBB0_12:
	imulq	$315653, %rcx, %rbx             # imm = 0x4D105
	xorl	%r15d, %r15d
	testq	%r11, %r11
	sete	%r15b
	je	.LBB0_13
.LBB0_14:
	sarq	$20, %rbx
	leaq	_ZL12pow10_double(%rip), %r13
	...
	movq	%rbx, %r12
	notq	%r12
	imull	$217707, %r12d, %ecx            # imm = 0x3526B
	shlq	$4, %r12
	movq	4688(%r12,%r13), %rbp
	shrl	$16, %ecx
	addl	%ecx, %r14d
	leal	7(%r14), %ecx
	shlxq	%rcx, %r10, %rdx
	...
	vmovdqa64	%zmm2, %zmm5
	mulxq	%rbp, %r8, %rcx
	mulxq	4696(%r12,%r13), %rdx, %rdx
	movabsq	$3472328296227680304, %r13      # imm = 0x3030303030303030
	addq	%r8, %rdx
	adcq	$0, %rcx
	negb	%r14b
	andl	$1, %r10d
	...
	leaq	(%r8,%r8), %rdx
	cmpq	%r14, %r8
	movabsq	$6189700196426901375, %r14      # imm = 0x55E63B88C230E77F
	leaq	(%rdx,%rdx,4), %rdx
	seta	%r12b
	cmovaq	%r8, %rdx
	mulxq	%r14, %r8, %r8
	...
	shrq	$25, %r8
	imulq	$-100000000, %r8, %r8           # imm = 0xFA0A1F00
	vpsrlq	$25, %zmm0, %zmm0
...
.LBB0_20:
	...
	movl	%ecx, %ecx
	movzbl	17(%rdx,%rcx,4), %r10d
	movzbl	18(%rdx,%rcx,4), %r12d
	leaq	(%rdx,%rcx,4), %r11
	movzbl	19(%rdx,%rcx,4), %r13d
	movzbl	(%r15,%r11), %edx
	leaq	(%rax,%r10), %rcx
	vmovdqu	%xmm0, (%rax,%r10)
	movq	%rbx, (%r14,%rcx)
	vmovups	(%r12,%rcx), %xmm0
	vmovups	%xmm0, (%r13,%rcx)
	movb	$46, (%rax,%r12)
	popq	%rbx
	.cfi_def_cfa_offset 48
	popq	%r12
	...
	je	.LBB0_21
.LBB0_25:
	leaq	_ZL17exp_result_double(%rip), %rax
	movq	2592(%rax,%r8,8), %rax
	movq	%rax, (%rcx,%rdx)
	shrq	$56, %rax
	addq	%rcx, %rax
	addq	%rdx, %rax
...
.LBB0_7:
	...
	ja	.LBB0_9
# %bb.8:
	imulq	$109951163, %rdx, %r9           # imm = 0x68DB8BB
	shrq	$40, %r9
	imulq	%rdi, %r9
	addq	%rdx, %r9
	imulq	$5243, %r9, %rdx                # imm = 0x147B
	shrq	$19, %rdx
	andq	%rsi, %rdx
	...
	retq
.LBB0_9:
	movabsq	$3022314549036573, %r9          # imm = 0xABCC77118461D
	mulxq	%r9, %r9, %r9
	shrq	$14, %r9
	imulq	$-100000000, %r9, %r10          # imm = 0xFA0A1F00
	addq	%rdx, %r10
	imulq	$109951163, %r9, %rdx           # imm = 0x68DB8BB
	imulq	$109951163, %r10, %r11          # imm = 0x68DB8BB
	shrq	$40, %rdx
	imulq	%rdi, %rdx
	shrq	$40, %r11
	imulq	%rdi, %r11
...
.LBB0_11:
	...
	.cfi_offset %r14, -32
	.cfi_offset %r15, -24
	movq	$-1074, %r14                    # imm = 0xFBCE
	movq	%r11, %r10
	jmp	.LBB0_12
.LBB0_13:
	addq	$-131237, %rbx                  # imm = 0xFFFDFF5B
	jmp	.LBB0_14
.LBB0_16:
	xorl	%r13d, %r13d
	jmp	.LBB0_17
...
.LBB0_5:
	...
	movl	$5136718, %esi                  # imm = 0x4E614E
	cmpq	%rcx, %rdx
	movl	$6712905, %ecx                  # imm = 0x666E49
	cmovel	%ecx, %esi
	movl	%esi, (%rax)
	addq	$3, %rax
	retq
.Lfunc_end0:
	.size	_Z5xjb64dPc, .Lfunc_end0-_Z5xjb64dPc
	.cfi_endproc
                                        # -- End function
...
_ZL12pow10_double:
	...
	.type	_ZL18e10_variable_data2,@object # @_ZL18e10_variable_data2
	.p2align	4, 0x0
_ZL18e10_variable_data2:
	...
	.type	_ZL17exp_result_double,@object  # @_ZL17exp_result_double
	.p2align	4, 0x0
_ZL17exp_result_double:
	...
	.ident	"Ubuntu clang version 21.1.6 (3ubuntu1)"
