...
LBB0_7:
	...
	orr	x8, x8, #0x3030303030303030
	fmov	x10, d1
	orr	x10, x10, #0x3030303030303030
	and	x11, x9, #0x78
	lsr	x10, x10, x11
	str	x10, [x0]
	sub	x9, x0, x9, lsr #3
...
LBB0_8:
	ldr	x1, [x11, #32]
	mov	x14, #4503599627370496          ; =0x10000000000000
	mov	w16, #1                         ; =0x1
	mov	w13, #1                         ; =0x1
LBB0_9:
	mov	x17, x12
...
LBB0_18:
	...
	mov	w1, #12337                      ; =0x3031
	add	x13, x1, x13, lsr #9
	cmp	x11, x17
	csel	x3, x13, x3, hi
	b	LBB0_12
LBB0_19:
	mov	x10, #16383                     ; =0x3fff
	movk	x10, #4218, lsl #16
	movk	x10, #23283, lsl #32
	cmp	x14, x10
	b.hi	LBB0_13
; %bb.20:
	add	x9, x9, x17
...
LBB0_23:
	...
	mov	x1, #0                          ; =0x0
	ldr	x15, [x11]
	mov	x17, #-1074                     ; =0xfffffffffffffbce
	b	LBB0_10
