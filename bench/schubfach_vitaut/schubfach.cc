...
// src link : https://github.com/vitaut/schubfach/blob/main/schubfach.cc , date : 2025.12.10 Commit 988c2a3
// modify by benchmark
...
char* schubfach_vitaut::dtoa(double value, char* buffer) noexcept {
